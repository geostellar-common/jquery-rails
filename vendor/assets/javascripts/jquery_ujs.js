 ...
 */
  ...
  $.rails = rails = {
    ...
    // Submit a form, may be overridden at $.rails.submitForm
  ...
  if (rails.fire($(document), 'rails:attachBindings')) {
    ...
    $(document).delegate(rails.formInputClickSelector, 'click.rails', function(e) {
      var button = $(this);
      ...
      rails.allowAction(button).then(
        function() {
          ...
          form.submit();
          // TODO: This breaks our jasmine tests
          // rails.submitForm(form);
        },
        function() {
          rails.stopEverything(e);
    ...
    $(document).delegate(rails.formSubmitSelector, 'ajax:beforeSend.rails', function(e) {
      if (this == e.target) rails.disableFormElements($(this));
    });

    $(document).delegate(rails.formSubmitSelector, 'ajax:complete.rails', function(e) {
